...
def generate_shares(data):
    ...
    # print("After Rsa")
    # print(img1)
    localStorage.setItem(item="publicKey",value= publicKey)
    localStorage.setItem(item= "num",value= num)
    ...
    print("Outside generate shares")


def compress_shares(img1="images/share1.png", img2="images/share2.png", img3="images/share3.png"):

    localStorage = localStoragePy('visual-cryptography', 'sqlite')
    publicKey = localStorage.getItem(item="publicKey")
    num = localStorage.getItem(item="num")
